...
export function CardPattern({ mouseX, mouseY, randomString }: any) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="from-sunflower-300 to-sunflower-800 absolute inset-0 bg-gradient-to-r opacity-0  backdrop-blur-xl transition duration-500 group-hover/card:opacity-100"
        style={style}
      />
      <motion.div
