    ...
    >
      ...
      <div className={`${id === 6 && 'flex justify-center'} h-full overflow-hidden`}>
        ...
        >
          ...
          <div className="z-10 font-sans text-sm font-extralight text-[#525367] md:max-w-32 md:text-xs lg:text-base">
            {description}
          </div>
          ...
          {/* remove mb-2 mt-2 */}
          <div
            className={`${[1, 6].includes(id) ? 'text-white' : 'text-zinc-700'} z-10 max-w-96 font-sans text-lg font-bold  dark:text-white lg:text-3xl`}
          >
            {title}
          </div>
            ...
            <div className="absolute -right-3 flex w-fit gap-1 lg:-right-2 lg:gap-5">
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    key={i}
                    className="rounded-lg bg-teal-500 px-3 py-2 text-center text-xs text-zinc-50 opacity-50 
                    lg:px-3 lg:py-4 lg:text-base lg:opacity-100"
                  >
                    {item}
                  </span>
                ))}
                <span className="rounded-lg bg-teal-500 px-3 py-4 text-center text-zinc-50 lg:px-3 lg:py-4"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                <span className="rounded-lg bg-teal-500 px-3 py-4 text-center text-zinc-50 lg:px-3 lg:py-4"></span>
